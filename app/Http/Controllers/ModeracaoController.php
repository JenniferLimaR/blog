...
class ModeracaoController extends Controller
{
    ...
    public function ModeracaoDenunciaPostagemAceito($id){
        ...
        return redirect()->route('ModeracaoDenunciaPostagem')->with('mensagem', 'Denuncia Aceita com sucesso!');
    }
    ...
    public function ModeracaoDenunciaPostagemNegado($id){
        ...
        return redirect()->route('ModeracaoDenunciaPostagem')->with('mensagem', 'Denuncia Negada com sucesso!');
    }
}
